...
namespace UnityEngine.Recorder.Examples
{
    ...
    public class MovieRecorderExample : MonoBehaviour
    {
        ...
        internal void Initialize()
        {
            ...
            // Configure Audio Input if m_RecordAudio is true
            if (m_RecordAudio)
            {
                m_Settings.CaptureAudio = true; // Enable audio capture
                // The default AudioInputSettings are used when CaptureAudio is true.
                // No need to assign m_Settings.AudioInputSettings directly unless you need to customize them.
                // If customization is needed, you'd typically do:
                // var audioSettings = m_Settings.AudioInputSettings as AudioInputSettings;
                // if (audioSettings != null) { /* configure audioSettings properties here */ }
                Debug.Log("Audio recording enabled for MovieRecorderExample.");
            }
            else
            {
                m_Settings.CaptureAudio = false;
                Debug.Log("Audio recording disabled for MovieRecorderExample.");
            }
